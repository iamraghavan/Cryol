...
const caseStudies = [
  {
    ...
    description:
      'How we modernized their e-commerce platform and boosted sales by 40%.',
  ...
  },
  {
    ...
    description:
      'Securing assets and achieving compliance with a robust security framework.',
    image: 'https://picsum.photos/600/400',
  ...
  },
  {
    ...
    description:
      'A user-centric mobile application to connect patients with doctors.',
    image: 'https://picsum.photos/600/400',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="space-y-4 text-center">
          ...
          <p className="mx-auto max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Explore how we've helped businesses like yours to achieve their
            goals.
          </p>
        </div>
        <div className="mx-auto mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {caseStudies.map((study) => (
            <Card
              key={study.title}
              className="overflow-hidden rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-primary/20"
            >
