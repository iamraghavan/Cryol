...
const blogPosts = [
  {
    ...
    description:
      'An in-depth look at the trends shaping the cloud industry in 2024 and beyond.',
  ...
  },
  {
    ...
    description:
      'Stay ahead of cyber threats with our expert analysis of the most pressing security risks.',
    image: 'https://picsum.photos/600/400',
    author: 'John Smith',
  ...
  },
  {
    ...
    description:
      'Learn how the agile methodology can transform your development lifecycle.',
    image: 'https://picsum.photos/600/400',
      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="space-y-4 text-center">
          ...
          <p className="mx-auto max-w-[900px] text-muted-foreground md:text-xl/relaxed lg:text-base/relaxed xl:text-xl/relaxed">
            Latest industry insights, articles, and news from our team of
            experts.
          </p>
        </div>
        <div className="mx-auto mt-12 grid grid-cols-1 gap-8 sm:grid-cols-2 lg:grid-cols-3">
          {blogPosts.map((post) => (
            <Card
              key={post.title}
              className="flex flex-col overflow-hidden rounded-2xl shadow-lg transition-transform duration-300 hover:scale-105 hover:shadow-primary/20"
            >
